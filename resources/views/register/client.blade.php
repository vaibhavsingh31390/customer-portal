...
<div class="main-content d-flex flex-column portal-shell__main portal-main">
    <form action="{{ route('register.complaint.export') }}" action2="{{ route('register.complaint.report') }}"
        ...
        <x-page-header title="Complaint Register" subtitle="Search and export your complaint records">
            <x-slot:actions>
                    ...
                    <div class="form-row portal-form-section">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" id="CLIENT_NAME" name="CLIENT_NAME" class="form-control disabled"
                                value="{{ $customer_name->name ?? '' }}" readonly>
                            <input type="hidden" id="client_cd" name="client_cd" value="{{ $customer_name->client_code ?? '' }}">
                        </div>
                    </div>
                    <div class="actions">
