...
<div class="main-content d-flex flex-column portal-shell__main portal-main">
    ...
    <form action="{{ route('save.create.complaint') }}" id="complaintForm" method="post" enctype="multipart/form-data" class="portal-form">
        @csrf
        @include('include.formHeader', ['title' => 'Complaint Create', 'subtitle' => 'Support — create complaint for a client'])
                        ...
                        <div class="portal-form-section">
                            ...
                            <div class="form-row">
                                    ...
                                    <div class="portal-form__control">
                                        <select id="P8_CUST_CD" name="P8_CUST_CD" class="form-control portal-select2" data-placeholder="Select customer…">
                                            ...
                                            @foreach ($customer as $cust)
                                                <option value="{{ $cust->client_code }}" data-src="{{ $cust->email }}">{{ $cust->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" id="P8_COMPLAINT_NO" name="P8_COMPLAINT_NO" class="form-control disabled" readonly>
                                </div>
                                <div class="form-group col-md-4">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="email" id="P3_CONTACT_MAIL_ID" name="P3_CONTACT_MAIL_ID" class="form-control">
                                </div>
                                <div class="form-group col-md-4">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" id="P8_CUST_NAME" name="P8_CUST_NAME" class="form-control disabled" readonly>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="portal-form__control">
                                        <select id="P8_ASSIGN_TO" name="P8_ASSIGN_TO" class="form-control portal-select2" data-placeholder="Select engineer…">
                                            ...
                                            @foreach ($assignto as $ass)
                                                <option value="{{ $ass->engineer_code }}">{{ $ass->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                        ...
                        <div class="portal-form-section">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <textarea id="P8_REASON" name="P8_REASON" class="form-control" maxlength="500"></textarea>
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="P8_ACTION">Action</label>
                                    <textarea id="P8_ACTION" name="P8_ACTION" class="form-control" maxlength="500"></textarea>
                                </div>
                                <div class="form-group col-md-12">
