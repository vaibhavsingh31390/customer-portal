                    ...
                    <div class="card-body">
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select id="P8_CUST_CD" name="P8_CUST_CD" class="form-control">
                                    <option value=""></option>
                                    @foreach ($customer as $cust)
                                        <option value="{{ $cust->client_cd }}" data-src="{{ $cust->client_mail_id }}"
                                            @if ($cust->client_cd === $data->cust_cd) selected @endif>
                                            {{ $cust->client_name }}</option>
                                    @endforeach
                                </select>
                            </div>

                            <div class="form-group col-md-4">
                                <label for="P8_COMPLAINT_NO">Module</label>
                            ...
                            <div class="form-group col-md-4">
                                <label for="P3_COMPL_DT"><span class="required text-danger">*</span>Complaint Date
                                </label>
                            ...
                            <div class="form-group col-md-4">
                                <label for="P8_CUST_NAME">Customer</label>
                            ...
                            <div class="form-group col-md-4">
                                <label for="P8_TIME_TAKEN">Time T.(hrs)</label>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select id="P8_ASSIGN_TO" name="P8_ASSIGN_TO" class="form-control">
                                    <option value=""></option>
                                    @foreach ($assignto as $ass)
                                        <option value="{{ $ass->eng_cd }}"
                                            @if ($ass->eng_cd === $data->assign_to) selected @endif>
                                            {{ $ass->eng_name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select id="P8_CHANGE_DONE_BY" name="P8_CHANGE_DONE_BY" class="form-control">
                                    <option value=""></option>
                                    @foreach ($assignto as $ass)
                                        <option value="{{ $ass->eng_cd }}"
                                            @if ($ass->eng_cd === $data->change_done_by) selected @endif>
                                            {{ $ass->eng_name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <textarea id="P8_ACTION" name="P8_ACTION" class="form-control" maxlength="500">{{ $data->action }}</textarea>
                            </div>
